            ...
            <div className="flex flex-col justify-center">
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-3 pt-4">
                  ...
                  <button className="border-2 border-blue-500 bg-white text-blue-600 hover:bg-blue-50 px-8 py-3 rounded-lg text-base md:text-lg font-semibold transition-colors cursor-pointer">
                    Get Started
                  </button>
                </div>
              </div>
